...
const focusAreas = [
  ...
  {
    title: 'Adoption',
    body: 'The moment a product becomes understandable enough to enter a real workflow.',
  },
]
...
const principles = [
  ...
  },
  {
    ...
    body: 'A token can create motion without creating real pull. What matters is what remains when incentives stop carrying the story.',
  },
  {
    number: '03',
...
export default function LandingPage({ mono = false }: LandingPageProps) {
  const featuredProof = proofCards[0]
  const secondaryProof = proofCards.slice(1)

  return (
    <div className={`page-root${mono ? ' theme-mono' : ''}`}>
      <Header />
      ...
      <main className="flex-1">
          ...
          <div className="container-max stack-lg">
            {mono ? (
              <div className="variant-banner">
                <div>
                  <p className="section-label">Grayscale study</p>
                  <p className="body-small">
                    A black-and-white version of the same layout so you can compare structure without color doing the work.
                  </p>
                </div>
                ...
                <aside className="hero-side">
                  <div className="portrait-card">
                    ...
                    <div className="portrait-card__body">
                      ...
                      <p className="body-small">Tokenization, onchain products, and the workflows that make adoption feel concrete instead of theoretical.</p>
                    </div>
                  </div>

                  <div className="aside-card">
                    <p className="section-label">A human layer</p>
                    <p className="body-small">I trust rooms where products are presented, challenged, and rebuilt in public more than polished positioning decks.</p>
                  </div>
                </aside>
              </div>
            </div>
        ...
        <section className="section-shell section-shell--dark">
          <div className="container-max stack-lg">
            <div className="section-head section-head--dark">
              ...
              <p className="section-description">
                These are the product tests I trust most when I am trying to understand whether something is truly usable or just well framed.
              </p>
            </div>
        ...
        <section id="work" className="section-shell">
          <div className="container-max stack-lg">
            <div className="section-head">
              ...
              <p className="section-description">
                These are the clearest examples of how I work through product questions around trust, incentives, workflow, and adoption.
              </p>
            </div>
            ...
            <div className="proof-grid">
              ...
              {secondaryProof.map((card, index) => (
                <article key={card.title} className="proof-card">
                  {index === 1 ? (
                    <div className="proof-card__media proof-card__media--compact">
                      <Image
                        src="/images/polkadot-hackathon.jpeg"
                        alt="Devinson Peña with the Polkadot hackathon group"
                        fill
                        unoptimized
                        className="object-cover"
        ...
        <section className="section-shell section-shell--muted">
          <div className="container-max stack-lg">
            ...
            <div className="card-grid card-grid--3">
              {background.map((item) => (
                <article key={item.company} className="content-card content-card--compact">
        ...
        <section id="contact" className="section-shell">
          <div className="container-max">
            <div className="cta-panel cta-panel--home">
              <div className="cta-panel__copy">
                ...
                <p className="body-copy">
                  ...
                  conversations around tokenization, market infrastructure, wallets, and product commercialization.
                </p>
                <div className="action-row">
