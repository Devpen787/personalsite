        ...
        <section className="section-shell">
          <div className="container-max stack-lg">
            <div className="page-hero">
              ...
              <h1 className="page-title">Open to thoughtful conversations around Web3 product clarity, adoption, and tokenization.</h1>
            ...
            <div className="cta-panel cta-panel--compact">
              <div className="cta-panel__copy">
                ...
                <h2 className="section-title">If you want context quickly, start with the CV, paper, and ChopDot brief.</h2>
              </div>
